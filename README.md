...
## 1. Introduction
In modern software development, defect prediction is essential for identifying high-risk files prone to errors. In this analysis, I explored defect prediction using a historical commit-based approach (Approach A) on two types of repositories: a large, highly active repository (OpenJ9) and a small, less active repository (Hiero). By leveraging historical commit data, I assessed the effectiveness of this method in identifying defect-prone files and evaluated its scalability, accuracy, and limitations.
